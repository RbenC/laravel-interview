...
@section('contenido')
    <div class="md:flex md:justifyy-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12">
            ...
            <p  class="p-10 text-2xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem error, repellat eum aperiam harum voluptate quae? Totam molestias, adipisci amet quos ducimus sequi cupiditate veniam modi, id dolorem accusantium soluta.</p>

            <a href="#" class="text-3xl bg-gray-600 hover:bg-gray-700 transition-colors cursor-pointer uppercase font-bold min-w-fit p-5 mx-10 my-10 text-white rounded-lg">Chat</a>
            
            {{-- <input 
                type="submit"
                value="chat"
                class="text-3xl bg-gray-600 hover:bg-gray-700 transition-colors cursor-pointer uppercase font-bold min-w-fit p-5 mx-10 my-10 text-white rounded-lg"
            > --}}
        </div>
